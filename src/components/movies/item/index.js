    ...
    return(
      <article className='movie'>
        ...
        <div className='movie__headline'>
          <time className='movie__date'>Year: {movie.year ? movie.year : 'Unknown'}</time>
          <ul className='movie__genres-list'>
            Genres:
            {movie.genres && movie.genres.length ?  movie.genres.map((g, idx) => {
        ...
        <div className='movie__meta meta'>
          <p className='meta__director'>Director: {movie.director ? movie.director : 'Unknown'}</p>
          <p className='meta__runtime'>Runtime: {movie.runtime ? movie.runtime + 'min.' : 'Unknown'}</p>
        </div>
